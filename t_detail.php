...
<script type="text/javascript" src="tablePrint/fun.js"></script>
</head>
<?php 
require_once("includes/conn.php");
...
if(isset($_POST['signup'])){
	...
	$q = "insert into t_detail set t_d_name='$category',t_normal='$normal',t_price='$dues'";
					...
					<div class="form-group">
							...
							<div class="col-lg-4 mine">
								<div class="row">
									<div class="col-md-12">
										...
										<span class="label label-block label-primary ">Test Name:</span>
								...
								<div class="row">
									...
									<div class="col-md-12">
										...
										<span class="label label-block label-info ">Normal Range:</span>

										<input type="text" class="form-control" name="normal">
										<br><br>

										<span class="label label-block label-danger ">Price:</span>
						...
						<div class="col-lg-8">
							...
							<div class="panel-heading">
								<h5 class="panel-title">List Of All Test</h5>
							...
							<div class="panel-body">
										...
										All Test of your Hospital with a simple search.
							</div>
							...
							<table class="table table-bordered table-hover datatable-highlight" id="table-id">
								...
								<tbody>						
										<?php 
												$query = "select * from t_detail";
												$run = mysqli_query($conn,$query);
												while ($row = mysqli_fetch_array($run)) {
													//extract($_row);
													$t_d_id = $row['t_d_id'];
											$t_d_name = $row['t_d_name'];

											$t_d_normal = $row['t_normal'];
											$t_d_price = $row['t_price'];

												?>
								
									<tr>
										
										<td><?php echo $t_d_id; ?></td>
													<td><?php echo $t_d_name; ?></td>
													<td><?php echo $t_d_normal; ?></td>
													<td><?php echo $t_d_price; ?></td>
										...
										<td class="text-center">
											<ul class="icons-list">
												<li class="dropdown">
													...
													<li><a href="del_test.php?del=<?php echo $t_d_id; ?> "><i class="icon-file-pdf"></i> Remove</a></li>
