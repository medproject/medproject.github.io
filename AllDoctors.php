										...
										<td class="text-center">
											<ul class="icons-list">
												<li class="dropdown">
													...
													<li><a href="delete_Doctor.php?del=<?php echo $s_id; ?> "><i class="icon-file-pdf"></i> Remove</a></li>
														<li><a href="ExportDoctor.php?doc_id=<?php echo $s_id; ?> "><i class="icon-file-pdf"></i> Export to .pdf</a></li>
													</ul>
												</li>
											</ul>
										</td>
