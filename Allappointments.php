												...
												<ul class="icons-list">
													<li class="dropdown">
														...
														<ul class="dropdown-menu dropdown-menu-right">
															...
															<li><a href="delete_appointment.php?del=<?php echo $s_id; ?> "><i class="icon-file-pdf"></i> Remove</a></li>
															<li><a target="_blank" href="ExportAppointment.php?App_id=<?php echo $s_id; ?> "><i class="icon-file-pdf"></i> Export to .pdf</a></li>
														</ul>
													</li>
												</ul>
											</td>
