				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">List Of All Patients</h5>
						...
						<div class="panel-body">
							Here You can Search All Patients Ever came to your Hospital with a simple search.
						</div>

						<table class="table table-bordered table-hover datatable-highlight" method="post" action="">
							<thead>
								<tr>
									<th>Name</th>
									<th>Age</th>
							...
							<tbody>
									...
									//extract($_row);
										...
										<tr>
											...
											<td><?php echo $ref_by_doc; ?></td>
											<td><span  class="label label-success"><?php echo $fee; ?></span>
											</td>
											<td><span  class="label label-danger"><?php echo $app_stat; ?></span>
											</td>
												...
												<ul class="icons-list">
													<li class="dropdown">
														...
														<ul class="dropdown-menu dropdown-menu-right">
															...
															<li><a href="delete_patient.php?del=<?php echo $s_id; ?> "><i class="icon-file-pdf"></i> Remove</a></li>
															<li><a target="_blank" href="print2.php?patient_id=<?php echo $s_id; ?> " ><i class="icon-file-pdf"></i> Export to .pdf</a></li>
														</ul>
													</li>
												</ul>
											</td>
